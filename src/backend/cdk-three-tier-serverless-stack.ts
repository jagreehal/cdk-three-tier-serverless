...
export class CdkThreeTierServerlessStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const table = new Table(this, NOTES_TABLE, {
    ...
    const api = new HttpApi(this, NOTES_API, {
      corsPreflight: {
    ...
    const websiteBucket = new Bucket(this, APP_BUCKET, {
    ...
    new BucketDeployment(this, APP_WEBSITE, {
    ...
    new AwsCustomResource(this, NOTES_API_RESOURCE, {
      logRetention: RetentionDays.ONE_DAY,
      onUpdate: {
        action: 'putObject',
        parameters: {
